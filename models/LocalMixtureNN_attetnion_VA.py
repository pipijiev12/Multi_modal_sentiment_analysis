...
class LocalMixtureNN_attention_VA(torch.nn.Module):
    def __init__(self, opt):
        ...
        """
        super(LocalMixtureNN_attention_VA, self).__init__()
...
#        self.hidden_units = opt.hidden_units
        ...
        self.linear_1 = nn.Linear(100,1000)
        self.linear_2 = nn.Linear(100,1000)
    ...
    def forward(self, in_modalities):
        ...
        for n_gram in self.ngram:
            ...
            n_gram_embedding_imag = self.linear_1(n_gram_embedding_imag)
            # print('n_gram_embedding_real',np.shape(n_gram_embedding_real))
            # print('n_gram_embedding_imag',np.shape(n_gram_embedding_imag))
            # print('n_gram_weight',np.shape(n_gram_weight))
