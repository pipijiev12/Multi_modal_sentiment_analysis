...
class LocalMixtureNN_attention_TV(torch.nn.Module):
    def __init__(self, opt):
        ...
        """
        super(LocalMixtureNN_attention_TV, self).__init__()
...
#        self.hidden_units = opt.hidden_units
    ...
    def forward(self, in_modalities):
        ...
        for n_gram in self.ngram:
            ...
            n_gram_embedding_real = self.linear1(n_gram_embedding_real)
            n_gram_embedding_imag = self.linear1(n_gram_embedding_imag)
