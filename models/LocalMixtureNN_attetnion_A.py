...
class LocalMixtureNN_attention_A(torch.nn.Module):
    def __init__(self, opt):
        ...
        """
        super(LocalMixtureNN_attention_A, self).__init__()
...
#        self.hidden_units = opt.hidden_units
    ...
    def forward(self, in_modalities):
        ...
        phases = self.phase_embed[2](word_indexes)
        # print('phases',np.shape(phases))
        amplitudes = self.proj_layers[2](in_modalities[2])
